          ...
          <div className="grid gap-3 sm:grid-cols-3">
            ...
            <div className="rounded-[20px] border border-black/10 bg-black/[0.03] p-4">
              ...
              <p className="mt-2 font-mono text-xs text-black/75">
                {chainPreview.lastBlock ? shortHash(chainPreview.lastBlock.hash, 16) : t("common.waiting")}
              </p>
            </div>
          </div>
        ) : null}
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-[24px] border border-black/10 bg-black/[0.03] p-5">
                ...
                <p className="mt-2 text-sm text-black/65">
                  {chainPreview.lastBlock ? formatDateTime(chainPreview.lastBlock.timestamp) : t("addEvent.genesisRequired")}
                </p>
              </div>
            </div>
